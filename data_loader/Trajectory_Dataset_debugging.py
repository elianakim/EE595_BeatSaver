...
class Trajectory_Dataset(torch.utils.data.Dataset):
    ...
    def preprocessing(self):
        ...
        for i in range(len(self.beat_timestamp)):
            ...
            idx = timestamp
        generated_df['dynamic'].to_csv('../dataset/20211213_p3_meta/dynamic.csv')
        generated_df.to_csv('../dataset/20211213_p3_meta/beat_timestamp_trajectory_dist_dynamic.csv')

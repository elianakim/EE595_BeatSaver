...
# multi-class
python main.py --type beat_change --dataset beat_original --model beat_change_model_light --method Src --log_suffix bd_reproduce_ts2_lr0.001_light --feat_eng --lr 0.001 --gpu_idx 0 --beat_type 2
python main.py --type beat_change --dataset beat_original --model beat_change_model_light --method Src --log_suffix bd_reproduce_ts3_lr0.001_light --feat_eng --lr 0.001 --gpu_idx 0 --beat_type 3
python main.py --type beat_change --dataset beat_original --model beat_change_model_light --method Src --log_suffix bd_reproduce_ts4_lr0.001_light --feat_eng --lr 0.001 --gpu_idx 0 --beat_type 4
# binary
...
# multi-class + downsample
python main.py --type beat_change --dataset beat_original --model beat_change_model_light --method Src --log_suffix bd_reproduce_ts2_lr0.001_ds_light --feat_eng --lr 0.001 --gpu_idx 0 --beat_type 2 --downsample
python main.py --type beat_change --dataset beat_original --model beat_change_model_light --method Src --log_suffix bd_reproduce_ts3_lr0.001_ds_light --feat_eng --lr 0.001 --gpu_idx 0 --beat_type 3 --downsample
python main.py --type beat_change --dataset beat_original --model beat_change_model_light --method Src --log_suffix bd_reproduce_ts4_lr0.001_ds_light --feat_eng --lr 0.001 --gpu_idx 0 --beat_type 4 --downsample
# binary + downsample
